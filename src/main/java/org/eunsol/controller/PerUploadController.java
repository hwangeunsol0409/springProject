...
@Controller
public class PerUploadController {
		...
		public void uploadFormPost(MultipartFile[] uploadFile, Model model) {
			//저장위치
			String uploadFolder = "C:\\PerUploadFile";
		...
		public ResponseEntity<byte[]> getFile(String fileName){
			...
			File file = new File("C:\\PerUploadFile\\" + fileName);
		...
		public ResponseEntity<String> deleteFile(String fileName, String type){
			...
			File file;
			try {
				file = new File("c:\\PerUploadFile\\"+URLDecoder.decode(fileName, "UTF-8"));
				file.delete();
